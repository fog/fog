...
<ReceiveMessageResponse xmlns="http://queue.amazonaws.com/doc/2009-02-01/">
  ...
  describe "converted SentTimestamp" do
    subject { timestamp 'SentTimestamp' }
  ...
  describe "converted ApproximateFirstReceiveTimestamp" do
    subject { timestamp 'ApproximateFirstReceiveTimestamp' }
