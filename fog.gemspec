...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".document",
     ...
     "spec/aws/ec2/associate_address_spec.rb",
     "spec/aws/ec2/attach_volume_spec.rb",
     ...
     "spec/aws/ec2/describe_key_pairs_spec.rb",
     "spec/aws/ec2/describe_regions_spec.rb",
     "spec/aws/ec2/describe_security_groups_spec.rb",
     "spec/aws/ec2/describe_snapshot_spec.rb",
     "spec/aws/ec2/describe_volumes_spec.rb",
     "spec/aws/ec2/detach_volume_spec.rb",
     "spec/aws/ec2/disassociate_address_spec.rb",
     "spec/aws/ec2/get_console_output_spec.rb",
     "spec/aws/ec2/reboot_instances_spec.rb",
     "spec/aws/ec2/release_address_spec.rb",
     "spec/aws/ec2/revoke_security_group_ingress_spec.rb",
     "spec/aws/ec2/run_instances_spec.rb",
     "spec/aws/ec2/terminate_instances_spec.rb",
     "spec/aws/s3/copy_object_spec.rb",
     "spec/aws/s3/delete_bucket_spec.rb",
     "spec/aws/s3/delete_object_spec.rb",
     "spec/aws/s3/get_bucket_location_spec.rb",
     "spec/aws/s3/get_bucket_spec.rb",
     "spec/aws/s3/get_object_spec.rb",
     "spec/aws/s3/get_request_payment_spec.rb",
     "spec/aws/s3/get_service_spec.rb",
     "spec/aws/s3/head_object_spec.rb",
     "spec/aws/s3/put_bucket_spec.rb",
     "spec/aws/s3/put_object_spec.rb",
     "spec/aws/s3/put_request_payment_spec.rb",
     "spec/aws/simpledb/batch_put_attributes_spec.rb",
     "spec/aws/simpledb/create_domain_spec.rb",
     "spec/aws/simpledb/delete_attributes_spec.rb",
     "spec/aws/simpledb/delete_domain_spec.rb",
     "spec/aws/simpledb/domain_metadata_spec.rb",
     "spec/aws/simpledb/get_attributes_spec.rb",
     "spec/aws/simpledb/list_domains_spec.rb",
