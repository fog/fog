...
if Fog.mock?
  Fog.credentials = {
    ...
    :exoscale_api_key                 => '',
    :exoscale_secret_access_key       => '',
    :exoscale_network_ids             => '',
    :exoscale_service_offering_id     => '5548bd7d-a1f4-588b-68fd-71b6b56907a5',
    :exoscale_template_id             => '0b42d10d-1359-1699-367f-0ec169896327',
    :exoscale_zone_id                 => 'd665d603-f10d-0e16-8799-5b43865b5416',
