...
module Fog
  module BareMetalCloud
    class LoadBalancing  < Fog::Service

      requires :bare_metal_cloud_password, :bare_metal_cloud_username
      recognizes :host, :port, :scheme, :persistent

      model_path 'fog/bare_metal_cloud/models/loadbalancing'

      request_path 'fog/bare_metal_cloud/requests/loadbalancing'
      request :list_farms
      request :remove_from_farm
      request :add_to_farm
      request :cancel_farm
      request :add_farm
