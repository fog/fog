  ...
  module Compute
    class AWS
      class Real
        ...
        # Add egress permissions to a security group. This only works with VPC
        #
        # ==== Parameters
        ...
        def authorize_security_group_egress(group_id, ip_permissions, options = {})
      ...
      class Mock
        ...
        def authorize_security_group_egress(group_id, ip_permissions, options = {})
          ...
          group = self.data[:security_groups][group_id]
          ...
          if group
            ...
            raise Fog::Compute::AWS::NotFound.new("The security group '#{group_id}' does not exist")
          end
        end
