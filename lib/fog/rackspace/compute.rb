              ...
              :last_modified => {
                ...
                :images  => {
                  112 =>
                    {:id => 112,
                      :status => "ACTIVE",
                      :updated_at => "2011-04-21T10:24:01-05:00",
                      :name => "Ubuntu 10.04 LTS"},
                  100 =>
                    {:id => 100,
                      :status => "ACTIVE",
                      :updated_at => "2011-09-12T09:09:23-05:00",
                      :name => "Arch 2011.10"},
                  31 =>
                    {:id => 31,
                      :status => "ACTIVE",
                      :updated_at => "2010-01-26T12:07:44-06:00",
                      :name => "Windows Server 2008 SP2 x86"},
                  108 =>
                    {:id => 108,
                      :status => "ACTIVE",
                      :updated_at => "2011-11-01T08:32:30-05:00",
                      :name => "Gentoo 11.0"},
                  109 =>
                    {:id => 109,
                      :status => "ACTIVE",
                      :updated_at => "2011-11-03T06:28:56-05:00",
                      :name => "openSUSE 12"},
                  89 =>
                    {:id => 89,
                      :status => "ACTIVE",
                      :updated_at => "2011-10-04T08:39:34-05:00",
                      :name => "Windows Server 2008 R2 x64 - SQL2K8R2 Web"},
                  24 =>
                    {:id => 24,
                      :status => "ACTIVE",
                      :updated_at => "2010-01-26T12:07:04-06:00",
                      :name => "Windows Server 2008 SP2 x64"},
                  110 =>
                    {:id => 110,
                      :status => "ACTIVE",
                      :updated_at => "2011-08-17T05:11:30-05:00",
                      :name => "Red Hat Enterprise Linux 5.5"},
                  57 =>
                    {:id => 57,
                      :status => "ACTIVE",
                      :updated_at => "2010-09-17T07:16:25-05:00",
                      :name => "Windows Server 2008 SP2 x64 - MSSQL2K8R2"},
                  85 =>
                    {:id => 85,
                      :status => "ACTIVE",
                      :updated_at => "2010-01-26T12:07:17-06:00",
                      :name => "Windows Server 2008 R2 x64"},
                  111 =>
                    {:id => 111,
                      :status => "ACTIVE",
                      :updated_at => "2011-09-12T10:53:12-05:00",
                      :name => "Red Hat Enterprise Linux 6"},
                  120 =>
                    {:id => 120,
                      :status => "ACTIVE",
                      :updated_at => "2012-01-03T04:39:05-06:00",
                      :name => "Fedora 16"},
                  119 =>
                    {:id => 119,
                      :status => "ACTIVE",
                      :updated_at => "2011-11-03T08:55:15-05:00",
                      :name => "Ubuntu 11.10"},
                  116 =>
                    {:id => 116,
                      :status => "ACTIVE",
                  ...
                  56 =>
                    {:id => 56,
                      :status => "ACTIVE",
                      :updated_at => "2010-09-17T07:12:56-05:00",
                  ...
                  86 =>
                    {:id => 86,
                      :status => "ACTIVE",
                      :updated_at => "2010-09-17T07:19:20-05:00",
